...
resource "aws_iam_role" "ml_engineer" {
  ...
  description = "Execution role for the ${var.project} ${var.environment} SageMaker environment"
...
resource "aws_iam_policy" "ml_engineer" {
  ...
  description = "Permissions for the ${var.project} ${var.environment} SageMaker ML engineer"
